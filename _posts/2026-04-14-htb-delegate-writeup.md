---
title: "Hack The Box: Delegate - Makine Çözümü (Write-up)"
...
# 🛡️ Hack The Box: Delegate - Tam Kapsamlı Sızma Testi Raporu

**Zorluk:** Medium  
**İşletim Sistemi:** Windows  
**Hedef:** Bilgi İfşası (Guest), Targeted Kerberoasting, Unconstrained Delegation İstismarı ve DCSync ile Domain Ele Geçirme.
...
**Adım 3:** SPN atandıktan sonra kullanıcının Kerberos hash'ini çekiyoruz ve John the Ripper ile kırıyoruz. Parola: `KALEB_2341`.
...
N.Thompson kullanıcısı ile sisteme dahil olduğumuzda, elimizdeki yetkilerin gücünü test ediyoruz.
...
**Adım 1: Krbrelayx ve PetitPotam** `krbrelayx` dinleyicisini başlattıktan sonra PetitPotam saldırısı ile Domain Controller'ı bizim sahte makinemize kimlik doğrulamaya zorluyoruz. DC'nin Kerberos biletini kaptıktan sonra hash'leri döküyoruz.
...
**Adım 2: Bayrakların Alınması** Elde edilen Administrator hash'i ile sisteme dalıyor ve her iki bayrağı da cebe indiriyoruz.
