...
![Nmap Taraması ve Hosts Dosyası Düzenleme](nmap ve etchosts.png)
...
![Gobuster VHOST Keşfi](gobuster arama.png)
![Staging Hosts Dosyasına Ekleme](stagingi tekrardan etchosta ekledik.png)
...
![Forgot Password ve Token Sızıntısı](ilk curl.png)
...
![Reset Password ve Hesap Ele Geçirme](ikinci curl.png)
...
![Flowise API Key Tespiti](giriş yapılıp api key alındı ve komuta basıldı.png)
...
![Flowise Reverse Shell Payload ve Bağlantı](shell alındı.png)
...
![Reverse Shell ve ENV Sızıntısı](bilgiler alındı.png)
...
![SSH Bağlantısı ve User Bayrağı](bilgiler ile ssha girildi ve flag alındı.png)
...
![Gogs Token Üretimi](bu sayfadan token oluşturuyoruz.png)
